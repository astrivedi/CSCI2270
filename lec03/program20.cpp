...
int main(int argc, char* argv[])  {
  ...
  Address myaddress(1614011140000, "Ashutosh Trivedi", "(720) 707-9663", "ashutosh.trivedi@gmail.com", "4141 Spruce Street","Philadelphia","PA",19104,39.948610,-75.177830); 
  myaddress.prettyPrint();
  return 0;
}
